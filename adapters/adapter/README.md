...
[![Go Reference](https://pkg.go.dev/badge/github.com/technance-foundation/socket.io/adapters/adapter/v3.svg)](https://pkg.go.dev/github.com/technance-foundation/socket.io/adapters/adapter/v3)
[![Go Report Card](https://goreportcard.com/badge/github.com/technance-foundation/socket.io/adapters/adapter/v3)](https://goreportcard.com/report/github.com/technance-foundation/socket.io/adapters/adapter/v3)
