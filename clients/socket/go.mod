module github.com/technance-foundation/socket.io/clients/socket/v3

go 1.26.0

require (
	github.com/technance-foundation/socket.io/clients/engine/v3 v3.0.5-beta.1
...
replace (
	github.com/technance-foundation/socket.io/clients/engine/v3 => ../../clients/engine
	...
	github.com/technance-foundation/socket.io/servers/socket/v3 => ../../servers/socket
