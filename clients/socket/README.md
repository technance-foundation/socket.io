...
[![Go Reference](https://pkg.go.dev/badge/github.com/technance-foundation/socket.io/clients/socket/v3.svg)](https://pkg.go.dev/github.com/technance-foundation/socket.io/clients/socket/v3)
[![Go Report Card](https://goreportcard.com/badge/github.com/technance-foundation/socket.io/clients/socket/v3)](https://goreportcard.com/report/github.com/technance-foundation/socket.io/clients/socket/v3)
...
```bash
go get github.com/technance-foundation/socket.io/clients/socket/v3
```
...
import (
    ...
    "github.com/technance-foundation/socket.io/clients/socket/v3"
)
...
- [Engine.IO Client for Go](https://github.com/technance-foundation/socket.io/tree/v3/clients/engine)
- [Socket.IO Server for Go](https://github.com/technance-foundation/socket.io/tree/v3/servers/socket)